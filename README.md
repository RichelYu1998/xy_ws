...
- **API优化** ([main.py:6719-6761](file:///D:/ws/xy_ws/main.py#L6719-L6761)):
  ...
  - 从商品列表中提取所有入库时间戳
  - 返回最早的入库时间（最新商品）
- **前端修复** ([index.html:2249-2293](file:///D:/ws/xy_ws/index.html#L2249-L2293)):
  - 优先显示精确时间戳（`created_time`）
  - 备用显示相对时间（`storage_duration`）
  - 根据时间差设置颜色：
    - 🟢 绿色：24小时以内（最新）
    - 🟡 橙色：72小时以内（较新）
    - 🔴 红色：其他（较旧）
...
- [index.html:2249-2293](file:///D:/ws/xy_ws/index.html#L2249-L2293) - 显示逻辑优化
- [skill.md:3018-3073](file:///D:/ws/xy_ws/skill.md#L3018-L3073) - 更新技术规范
