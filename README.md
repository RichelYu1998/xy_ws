...
### v4.1.0 (2026-08-30) - 🗑️清理 v4.1: BOM字符清理+临时文件整理+项目规范化
...
### v5.0.0 (2026-08-31) - 🏗️架构优化 v5.0: 文档生成器100%动态化重构 - 删除硬编码脚本/更新skill.md和README.md/从skill.md生成skill.docx (2026-08-31)
